"""
Django settings for PayrollSer project.
...
SECRET_KEY = 'django-insecure-8z*0uxchnxd4-aegismnwoew_3q2k+@)(kht0#awh3ef$0uizj'
...
WSGI_APPLICATION = 'PayrollSer.wsgi.application'
